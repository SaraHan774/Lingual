...
> **Last indexed:** 2026-04-18 (FlashCard UI/UX 개선 AC-9~AC-15 추가)
...
- [04 — FlashCard (단어장)](./docs/prd/04-feature-flashcard.md) · **status: in-progress**
  단어 카드 목록/숙련도/즐겨찾기 shipped. 카드 추가(일기 상세 텍스트 선택) · 카드 삭제 in-progress. 필터 칩·숙련도 레이블·통계 배너·Empty State·언어 배지 UI/UX 개선 in-progress (AC-9~AC-15). 자동 단어 추출은 Phase 2.
